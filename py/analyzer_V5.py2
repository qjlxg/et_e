...
def generate_merged_table(df_group):
    ...
    FULL_HEADER = (
        ...
        f"MACD信号 | 布林带位置 | 净值/MA50 | **MA50/MA250健康度** | 净值/MA250 | 试水买价 (跌3%) |\n"
    )
    # 完整的 13 列分隔符
    FULL_SEPARATOR = f"| :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |\n"
...
if __name__ == '__main__':
    success = main()
    if success:
        print(f"脚本执行完毕。V5.0 策略报告已更新为'表格合并模式'，并已设置可试仓信号下限 (Score >= {MIN_BUY_SIGNAL_SCORE:.1f})。")
    else:
